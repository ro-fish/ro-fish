...
;
;
const usersPath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'src/lib/users.json');
async function createUser(userData) {
    ...
    users.push(newUser);
    await __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["promises"].writeFile(usersPath, JSON.stringify(users, null, 2));
    return newUser;
}
...
async function getUsers() {
    try {
        const data = await __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["promises"].readFile(usersPath, 'utf-8');
...
async function POST(request) {
    try {
        ...
        const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$users$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["verifyUser"])(email, password);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__d17c05d5._.js.map