...
public class FishingSpotsController {
    ...
    @Operation(
            summary = "Get all fishing spots.",
            description = "Retrieves all fishing spots from the database.",
            responses = {
    ...
    @Operation(
            summary = "Add a new fishing spot.",
            description = "Adds a new fishing spot to the database. Only accessible by users with ADMIN role.",
            responses = {
    ...
    @Operation(
            ...
            description = "Deletes a fishing spot from the database. Only accessible by users with ADMIN role.",
            parameters = {
                    @Parameter(name = "id", description = "ID of the fishing spot to delete.")
            },
            responses = {
