  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    axios
      .post(ADD_POST, {
        title: form.title,
        content: form.body,
        thumbnailPat: form.thumbnail,
        imagePath: form.mainImage,
      })
      .then((response) => {
        console.log("Articol adăugat cu succes:", response.data);
        setForm({
          title: "",
          body: "",
          category: "pesti",
      ...
      .catch((error) => {
        ...
        alert(
          "A apărut o eroare la publicarea articolului. Te rugăm să încerci din nou.",
        );
      });
  };
